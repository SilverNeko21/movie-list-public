function getMovieList() {
    ...
    .then(function (response) {
      ...
      MovieData.forEach(function (movie) {
        ...
        document.querySelector('#movie_cat').innerHTML += `<div id="box"> <img id="movid" src=${movie.movie_picture} > <h1>${movie.movie_title}</h1> <h2> YEAR :${movie.movie_year_released} </h2> <h3>GENRE: ${movie.movie_genre}</h3> <h4>ID: ${movie.movie_id}</h4>`
